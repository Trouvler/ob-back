...
from utils.api import CSRFExemptAPIView, CSRFExemptAPIView_quiz
import logging
...
class SimditorImageUploadAPIView_quiz(CSRFExemptAPIView_quiz):
    request_parsers = ()
...
class SimditorFileUploadAPIView_quiz(CSRFExemptAPIView_quiz):
    request_parsers = ()
