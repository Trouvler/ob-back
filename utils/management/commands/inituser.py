...
from account.models import AdminType, ProblemPermission, User, UserProfile, QuizPermission
    ...
    def handle(self, *args, **options):
        ...
        if action == "create_super_admin":
            ...
            user = User.objects.create(username=username, admin_type=AdminType.SUPER_ADMIN,
                                       problem_permission=ProblemPermission.ALL, quiz_permission=QuizPermission.ALL)
