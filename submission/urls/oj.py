...
from ..views.oj import SubmissionAPI, SubmissionListAPI, ContestSubmissionListAPI, SubmissionExistsAPI, SubmissionQuizAPI, SubmissionQuizExistsAPI, SubmissionQuizListAPI
...
urlpatterns = [
    ...
    url(r"^submissions_quiz/?$", SubmissionQuizListAPI.as_view(), name="submission_quiz_list_api"),
