...
from judge.dispatcher_quiz import process_pending_task as process_pending_task_quiz
...
class TestCasePruneAPI(APIView):
    ...
    def get_orphan_ids():
        ...
        db_ids = Quiz.objects.all().values_list("test_case_id", flat=True)
