...
from ..views.oj import (ApplyResetPasswordAPI, ResetPasswordAPI,
                        ...
                        ProfileProblemDisplayIDRefreshAPI, ProfileQuizDisplayIDRefreshAPI,
...
urlpatterns = [
    ...
    url(r"^profile/fresh_display_id", ProfileQuizDisplayIDRefreshAPI.as_view(), name="display_id_fresh"),
