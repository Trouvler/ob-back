...
from .models import AdminType, ProblemPermission, User, UserProfile, QuizPermission
...
class UserAdminSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ["id", "username", "email", "admin_type", "problem_permission", "quiz_permission", "real_name",
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ["id", "username", "email", "admin_type", "problem_permission", "quiz_permission",
                  "create_time", "last_login", "two_factor_auth", "open_api", "is_disabled"]
...
class EditUserSerializer(serializers.Serializer):
    ...
    quiz_permission = serializers.ChoiceField(choices=(QuizPermission.NONE, QuizPermission.OWN,
                                                          QuizPermission.ALL))
