...
class User(AbstractBaseUser):
    ...
    quiz_permission = models.TextField(default=QuizPermission.NONE)
    ...
    def can_mgmt_all_quiz(self):
        return self.quiz_permission == QuizPermission.ALL
...
class UserProfile(models.Model):
    ...
    acm_quizs_status = JSONField(default=dict)
    # like acm_problems_status, merely add "score" field
    oi_quizs_status = JSONField(default=dict)
    ...
    def add_accepted_quiz_number(self):
        self.accepted_number = models.F("accepted_number") + 1
        self.save()
